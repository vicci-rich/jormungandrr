...
public class FullNodeHttpApiService implements Service {
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(sendBlockByNumServlet), "/sendblockbynum");
      context.addServlet(new ServletHolder(sendBatchBlockByNumServlet), "/sendbatchblockbynum");
      context.addServlet(new ServletHolder(getBlockByIdServlet), "/getblockbyid");
      context.addServlet(new ServletHolder(sendBlockByIdServlet), "/sendblockbyid");
