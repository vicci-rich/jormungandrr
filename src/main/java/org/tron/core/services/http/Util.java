...
//    JSONObject jsonObject = JSONObject.parseObject(JsonFormat.printToString(block));
    ...
    jsonObject.put("block_number", blockCapsule.getNum());
    jsonObject.put("timestamp", blockCapsule.getTimeStamp());
    jsonObject.put("parent_hash", blockCapsule.getParentHash().toString());
    jsonObject.put("transaction_root", blockCapsule.getMerkleRoot().toString());
    jsonObject.put("witness_address", Wallet.encode58Check(blockCapsule.getWitnessAddress().toByteArray()));
    jsonObject.put("witness_signature", ByteArray.toHexString(block.getBlockHeader().getWitnessSignature().toByteArray()));
    jsonObject.put("size", block.getSerializedSize());
    if (!blockCapsule.getTransactions().isEmpty()) {
      jsonObject.put("transactions", printTransactionListToKafkaJSON(blockCapsule.getTransactions()));
    }
    return jsonObject.toJSONString();
  }
  ...
  public static JSONArray printTransactionListToKafkaJSON(List<TransactionCapsule> list) {
    ...
    list.stream().forEach(transactionCapsule -> {
      transactions.add(printTransactionToKafkaJSON(transactionCapsule.getInstance()));
    });
    return transactions;
  }
      ...
      try {
        ...
        switch (contract.getType()) {
          case AccountCreateContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(accountCreateContract.getOwnerAddress().toByteArray()));
            contractJson.replace("account_address", Wallet.encode58Check(accountCreateContract.getAccountAddress().toByteArray()));
            break;
...
//            contractJson.replace("owner_address", Wallet.encode58Check(contractJson.getBytes("owner_address")));
//            contractJson.replace("to_address", Wallet.encode58Check(contractJson.getBytes("to_address")));
            contractJson.replace("owner_address", Wallet.encode58Check(transferContract.getOwnerAddress().toByteArray()));
            contractJson.replace("to_address", Wallet.encode58Check(transferContract.getToAddress().toByteArray()));
            break;
          case TransferAssetContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(transferAssetContract.getOwnerAddress().toByteArray()));
            contractJson.replace("to_address", Wallet.encode58Check(transferAssetContract.getToAddress().toByteArray()));
            break;
          case VoteAssetContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(voteAssetContract.getOwnerAddress().toByteArray()));
            JSONArray voteAddresses = contractJson.getJSONArray("vote_address");
            for (int i = 0; i < voteAddresses.size(); i++) {
              voteAddresses.set(i, Wallet.encode58Check(voteAssetContract.getVoteAddress(i).toByteArray()));
//              votes.getJSONObject(i).replace("vote_address", Wallet.encode58Check(votes.getJSONObject(i).getBytes("vote_address")));
            }
            break;
          case VoteWitnessContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(voteWitnessContract.getOwnerAddress().toByteArray()));
//            for (Vote vote: voteWitnessContract.getVotesList()) {
//            }
            JSONArray votes = contractJson.getJSONArray("votes");
            for (int i = 0; i < votes.size(); i++) {
              votes.getJSONObject(i).replace("vote_address", Wallet.encode58Check(voteWitnessContract.getVotes(i).getVoteAddress().toByteArray()));
//              votes.getJSONObject(i).replace("vote_address", Wallet.encode58Check(votes.getJSONObject(i).getBytes("vote_address")));
            }
            break;
          case WitnessCreateContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(witnessCreateContract.getOwnerAddress().toByteArray()));
            break;
          case AssetIssueContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(assetIssueContract.getOwnerAddress().toByteArray()));
            break;
          case WitnessUpdateContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(witnessUpdateContract.getOwnerAddress().toByteArray()));
            break;
          case ParticipateAssetIssueContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(participateAssetIssueContract.getOwnerAddress().toByteArray()));
            contractJson.replace("to_address", Wallet.encode58Check(participateAssetIssueContract.getToAddress().toByteArray()));
            break;
          case AccountUpdateContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(accountUpdateContract.getOwnerAddress().toByteArray()));
            break;
          case FreezeBalanceContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(freezeBalanceContract.getOwnerAddress().toByteArray()));
            break;
          case UnfreezeBalanceContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(unfreezeBalanceContract.getOwnerAddress().toByteArray()));
            contractJson.replace("receiver_address", Wallet.encode58Check(unfreezeBalanceContract.getReceiverAddress().toByteArray()));
            break;
          case UnfreezeAssetContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(unfreezeAssetContract.getOwnerAddress().toByteArray()));
            break;
          case WithdrawBalanceContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(withdrawBalanceContract.getOwnerAddress().toByteArray()));
            break;
          case UpdateAssetContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(updateAssetContract.getOwnerAddress().toByteArray()));
            break;
          case CreateSmartContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(deployContract.getOwnerAddress().toByteArray()));
          ...
          case TriggerSmartContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(triggerSmartContract.getOwnerAddress().toByteArray()));
            contractJson.replace("contract_address", Wallet.encode58Check(triggerSmartContract.getContractAddress().toByteArray()));
            break;
          case ProposalCreateContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(proposalCreateContract.getOwnerAddress().toByteArray()));
            break;
          case ProposalApproveContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(proposalApproveContract.getOwnerAddress().toByteArray()));
            break;
          case ProposalDeleteContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(proposalDeleteContract.getOwnerAddress().toByteArray()));
            break;
          case ExchangeCreateContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(exchangeCreateContract.getOwnerAddress().toByteArray()));
            break;
          case ExchangeInjectContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(exchangeInjectContract.getOwnerAddress().toByteArray()));
            break;
          case ExchangeWithdrawContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(exchangeWithdrawContract.getOwnerAddress().toByteArray()));
            break;
          case ExchangeTransactionContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(exchangeTransactionContract.getOwnerAddress().toByteArray()));
            break;
          case UpdateSettingContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(updateSettingContract.getOwnerAddress().toByteArray()));
            contractJson.replace("contract_address", Wallet.encode58Check(updateSettingContract.getContractAddress().toByteArray()));
            break;
          case UpdateEnergyLimitContract:
            ...
            contractJson.replace("owner_address", Wallet.encode58Check(updateEnergyLimitContract.getOwnerAddress().toByteArray()));
            contractJson.replace("contract_address", Wallet.encode58Check(updateEnergyLimitContract.getContractAddress().toByteArray()));
            break;
    ...
    jsonTransaction.put("transaction_id", txID);
